...
export function EditTransactionDialog({ open, onOpenChange, wallets, categories, transaction, onSuccess }: EditTransactionDialogProps) {
    ...
    useEffect(() => {
        if (transaction) {
            setFormData({
                ...
                transferFee: transaction.transferFee?.toString() || "",
